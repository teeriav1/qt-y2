...
class Example(QWidget):
    ...
    def go_showinfo_phase(self):
        ...
        # If not, then not run
        list_of_reset_stages = ["go_sorting_stage", "manual_sorting", 2,"add_keyword_and_rerun","manual_adding_of_lines_add_a_line"]
    ...
    def ask_amount(self):
        self.state= "start_saving_program_step_info"
        if debug:
    ...
    def paintEvent(self, event):
        def piechart1():
                ...
                self.view.show()
        def piechart2():
            # This draws the piechart of the values that user hopes and dreams to archieve
            # This chart will be drawn below the first chart so that the difference can be seen
            pass
